...
function getFriendlyError(msg: string, fallback: string): string {
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!schoolId)              { setError(t("selectSchool")); return; }
    ...
    try {
      ...
      toast({ title: t("welcomeBack"), description: t("campusReady") });
      router.push("/main");
    } catch {
        ...
        <div className="dash-card p-8 space-y-6 shadow-xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              {schoolsLoading && (
                <p className="text-[10px] text-muted-foreground">{t("loadingSchools")}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[10px] text-muted-foreground">{t("studentIdHint")}</p>
            </div>
