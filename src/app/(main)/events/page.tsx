            ...
            <button
              ...
              className={cn(
                ...
                selectedCategory === cat 
                  ? "bg-gold border-gold text-obsidian shadow-[0_0_15px_rgba(212,184,106,0.3)]" 
        ...
        <Tabs defaultValue="upcoming" className="w-full">
          ...
          <TabsContent value="upcoming" className="pt-6">
            ...
            <div className="mt-12 flex flex-col items-center gap-4 py-8 border-2 border-dashed border-border/50 rounded-2xl bg-muted/5">
              ...
              <Button variant="outline" className="mt-2 h-9 text-[10px] font-bold uppercase tracking-widest border-gold/20 text-gold hover:bg-gold/10">
