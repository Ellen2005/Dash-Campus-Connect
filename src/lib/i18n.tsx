...
const en = {
  ...
  faqSubtitle: "Common questions and answers about Dash",
  ...
  campusReady: "Your campus network is ready.",
  loadingSchools: "Loading schools…",
  studentIdLabel: "Student ID", studentIdPlaceholder: "e.g. 2024CS001",
  studentIdHint: "Your student registration number",
  ...
  step2Email: "You will be notified inside the app once approved",
  ...
  unknown: "Unknown", suggested: "Suggested",
...
const fr: Record<TranslationKey, string> = {
  ...
  faqSubtitle: "Questions et réponses courantes sur Dash",
  ...
  selectSchool: "Veuillez sélectionner votre école.",
  enterStudentId: "Veuillez saisir votre numéro étudiant.",
  passwordMinLength: "Le mot de passe doit contenir au moins 6 caractères.",
  networkError: "Erreur réseau. Veuillez vérifier votre connexion et réessayer.",
  campusReady: "Votre réseau campus est prêt.",
  loadingSchools: "Chargement des écoles…",
  studentIdLabel: "Numéro étudiant", studentIdPlaceholder: "ex. 2024CS001",
  studentIdHint: "Votre numéro d'inscription étudiant",
  ...
  step2Email: "Vous serez notifié dans l'application une fois approuvé",
  ...
  unknown: "Inconnu", suggested: "Suggestions",
